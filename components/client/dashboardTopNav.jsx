...
const TopNav = ({account, theme, setTheme, toggleSideNav}) => {
  ...
  const MaterialUISwitch = styled(Switch)(({ theme }) => ({
    ...
    '& .MuiSwitch-thumb': {
      backgroundColor: theme.palette.mode === 'dark' ? '#003892' : '#dbdbdb',
      width: 32,
      height: 32,
      '&:before': {
        content: "''",
    ...
    <div className="clientDashboard_topnav">
      ...
      <div className="clientDashboard_topnav-menu">
        ...
        <div className="clientDashboard_topnav-menu-account">
          <div className="clientDashboard_topnav-menu-account-svg">
            <SVG svg={'account-2'}></SVG>
          </div>
