...
const Dashboard = ({nav, hideSideNav, showSideNav, changeView, slab, createSlab, addSlabImages}) => {
  ...
  const generateQR = async (e) => {
    ...
    if(slab.size_1 && slab.size_2 && slab.lot_number && slab.material){
      ...
      if(!slab.material){setError('Slab name is empty, please fill out.'); window.scrollTo(0,document.body.scrollHeight); return}
    }
  }
              ...
              <form className="clientDashboard-view-slab_form" onSubmit={handleAddSlab}>
                ...
                <div className="form-group-triple">
                  ...
                  <div className="form-group-triple-input">
                    <textarea id="quantity" rows="2" name="quantity" placeholder="(Quantity)" value={slab.quantity} onChange={(e) => (validateIsNumber('quantity'), createSlab('quantity', e.target.value))}></textarea>
                  </div>
                </div>
                <div className="form-group-triple">
                  ...
                  <div className="form-group-triple-input units">
                    <span></span>
                    <textarea id="size_1" rows="2" name="size_1" placeholder="# in" value={slab.size_1} onChange={(e) => (validateIsNumber('size_1'), createSlab('size_1', e.target.value))}></textarea>
                    <textarea id="size_2" rows="2" name="size_2" placeholder="# in" value={slab.size_2} onChange={(e) => (validateIsNumber('size_2'), createSlab('size_2', e.target.value))}></textarea>
                  </div>
                </div>
                <div className="form-group-triple">
                  <label htmlFor="material">Thickness</label>
                  <div className="form-group-triple-input">
                    <textarea id="thickness" rows="2" name="thickness" placeholder="(Thickness)" value={slab.thickness} onChange={(e) => (validateIsNumber('thickness'), createSlab('thickness', e.target.value))}></textarea>
                  </div>
                </div>
                <div className="form-group-double-dropdown">
                ...
                <div className="form-group-triple">
                  ...
                  <div className="form-group-double-dropdown-input">
                    ...
                    <textarea id="price_slab" rows="2" placeholder="0.00" className="dollar-input" value={slab.price_slab == 'NaN' ? '' : slab.price_slab} onChange={(e) => createSlab('price_slab', parseFloat(e.target.value).toFixed(2))}></textarea>
                  </div>
                </div>
                <div className="form-group-triple">
                  ...
                  <div className="form-group-double-dropdown-input">
                    <SVGs svg={'dollar'} classprop="dollar"></SVGs>
                    <textarea id="price_sqft" rows="2" placeholder="0.00" className="dollar-input" value={slab.price_sqft == 'NaN' ? '' : slab.price_sqft} onChange={(e) => createSlab('price_sqft', parseFloat(e.target.value).toFixed(2))}></textarea>
                  </div>
                </div>
                <div className="form-group-triple">
                  <label htmlFor="block">Block Number</label>
                  <div className="form-group-triple-input">
                    <textarea id="block" rows="2" placeholder="(Block #)" value={slab.block} onChange={(e) => (validateIsNumber('block'), createSlab('block', e.target.value))}></textarea>
                  </div>
                </div>
                <div className="form-group-double-dropdown">
                  <label htmlFor="supplier">Supplier</label>
                  <div className="form-group-double-dropdown-input">
                    <textarea rows="2" name="supplier" placeholder="(Select Supplier)" readOnly onClick={() => setInputDropdown('supplier')} value={slab.supplier} onChange={(e) => createSlab('supplier', e.target.value)}></textarea>
                ...
                <div className="form-group-double-dropdown">
                  ...
                  <div className="form-group-double-dropdown-input">
                    <textarea rows="2" name="location" placeholder="(Select Location)" readOnly value={slab.location} onClick={() => setInputDropdown('location')} onChange={(e) => createSlab('location', e.target.value)}></textarea>
                ...
                <div className="form-button-container">
                  <button type="submit" className="form-button">Add Slab</button>
                  <div className="form-error-container">
